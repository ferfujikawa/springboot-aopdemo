...
public class MyDemoLoggingAspect {
    ...
    @Around("execution(* com.luv2code.springbootaopdemo.service.*.getFortune(..))")
    ...
    @After("execution(* com.luv2code.springbootaopdemo.dao.AccountDAO.findAccounts(..))")
    ...
    @AfterThrowing(
        pointcut = "execution(* com.luv2code.springbootaopdemo.dao.AccountDAO.findAccounts(..))",
        throwing = "theExc"
    )
